    ...
    return (
        <div className="relative w-full h-[700px] bg-gray-50 rounded-3xl overflow-hidden shadow-inner border border-gray-200">
            ...
            <div className="absolute top-6 left-6 z-10 flex flex-col gap-3">
                <div className="bg-white/80 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white/50 w-48">
                    <h4 className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-3">Controls</h4>
                    <button
                        onClick={() => setShowLabels(!showLabels)}
                        className={`w-full px-4 py-2.5 text-xs font-black rounded-xl transition-all flex items-center justify-between ${showLabels
                    ...
                    <div className="mt-4 flex items-center gap-2 text-[9px] font-bold text-gray-400 bg-gray-50 p-2 rounded-lg">
